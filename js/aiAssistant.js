...
(function () {
  ...
  function handleUserQuery(query) {
    ...
    .catch(err => {
      ...
      typingMsg.remove();
      let fallbackText = "I am Sanjay's AI Assistant! You can explore his 69+ projects categorized into <strong>AI & Machine Learning</strong>, <strong>Web Applications</strong>, <strong>Tools & Security</strong>, <strong>Games</strong>, and <strong>Portfolios & Profiles</strong>. Direct messages can be sent to <strong>sanjaygl2006@gmail.com</strong>.";
      ...
      if (lower.includes("contact") || lower.includes("email") || lower.includes("mail") || lower.includes("message")) {
        ...
        fallbackText = "Sanjay has built 69+ projects including DermAI, AI Agent using Google API, DataGauge, Pure Weaves E-Commerce, Property Manager Dashboard, and Paperless Office System. Check them out on the <a href='projects.html' style='color:var(--emerald-primary)'>Projects Page</a>!";
