...
def fetch_info(url):
    ...
    try:
        ...
        filename = og_title or title or ""
        filename = filename.replace(" - Google Drive", "").strip()
        return {"url": url, "filename": filename, "og_title": og_title, "title": title}
...
out_path = r"C:\Users\Sanjay G L\.gemini\antigravity-ide\brain\90cb5e12-c0c8-4ee6-8e95-faae5e519f2b\scratch\drive_results.json"
